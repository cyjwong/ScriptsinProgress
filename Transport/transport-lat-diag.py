...
dl_nz     = 100    # number z-steps for x-y field plots        
dl_z_mmin = 0.     # min z to make plots 
dl_z_mmax = z_adv     # max z to make plots 
...
dlr_nz = 1000  
dlr_z_mesh = linspace(z_launch,z_adv,dlr_nz+1)
