...
rx  = {key: InitialRadius for key in sp.keys()}
ry  = {key: InitialRadius for key in sp.keys()}
...
n_grid = GridNumber      # number grid cells (no symmetries) 
...
z_adv     = PeriodLength*NumberofPeriods       # Four jaw collimator


ds = PeriodLength/nstep_period             # Axial advance step 
